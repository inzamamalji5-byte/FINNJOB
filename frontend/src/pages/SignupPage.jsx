...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-finn-slate-50 flex" data-testid="signup-page">
      {/* Left Side - Image */}
      <div className="hidden lg:flex lg:flex-1 bg-finn-slate-900 items-center justify-center p-12">
        <div className="max-w-lg text-center">
          ...
          <p className="text-finn-slate-400 text-lg">
            Create your free account and discover flexible job opportunities near you.
          </p>
        </div>
      </div>
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-finn-slate-600">
                Get started with FinnJob in seconds
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" data-testid="signup-form">
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-finn-slate-400" />
                  <Input
                    id="name"
                    name="name"
                    type="text"
              ...
              <div>
                ...
                <p className="text-finn-slate-500 text-xs mt-1">
            ...
            <p className="text-center text-finn-slate-500 text-xs mt-4">
